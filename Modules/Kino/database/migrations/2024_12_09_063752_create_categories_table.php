...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('kino_categories')->insert([
            ...
            ['id' => 2, 'slug' => 'series', 'name' => 'Сериалы', 'title' => 'Сериалы смотреть онлайн', 'description' => 'Сериалы стали неотъемлемой частью современного развлекательного контента, привлекая зрителей своим разнообразием и глубиной сюжета.'],
            ['id' => 3, 'slug' => 'animation', 'name' => 'Мультфильмы', 'title' => 'Мультфильмы смотреть онлайн', 'description' => 'Хотите смотреть мультфильмы онлайн бесплатно в хорошем качестве? Тогда милости просим на наш портал!'],
        ]);
        ...
        DB::table('kino_categories')->insert([
            ...
            ['id' => 4, 'slug' => 'boeviki', 'name' => 'Боевики'],
            ['id' => 5, 'slug' => 'voennye', 'name' => 'Военные'],
            ['id' => 6, 'slug' => 'detective', 'name' => 'Детективы'],
            ['id' => 7, 'slug' => 'dlya-vsej-semi', 'name' => 'Семейные'],
            ['id' => 8, 'slug' => 'detskiy', 'name' => 'Для детей'],
            ['id' => 9, 'slug' => 'drama', 'name' => 'Драмы'],
            ['id' => 10, 'slug' => 'history', 'name' => 'Исторические'],
            ['id' => 11, 'slug' => 'comedy', 'name' => 'Комедии'],
            ['id' => 12, 'slug' => 'crime', 'name' => 'Криминал'],
            ['id' => 13, 'slug' => 'melodramy', 'name' => 'Мелодрамы'],
            ['id' => 14, 'slug' => 'adventures', 'name' => 'Приключения'],
            ['id' => 15, 'slug' => 'thriller', 'name' => 'Триллеры'],
            ['id' => 16, 'slug' => 'horror', 'name' => 'Ужасы'],
            ['id' => 17, 'slug' => 'fantastika', 'name' => 'Фантастика'],
            ['id' => 18, 'slug' => 'fentezi', 'name' => 'Фэнтези'],
            ['id' => 19, 'slug' => 'foreign', 'name' => 'Зарубежные'],

            // Категории для сериалов отличные от фильмов
            ['id' => 20, 'slug' => 'anime', 'name' => 'Аниме'],
            ['id' => 21, 'slug' => 'doramy', 'name' => 'Дорамы'],
            ['id' => 22, 'slug' => 'latinoamerikanskie', 'name' => 'Латиноамериканские'],
            ['id' => 23, 'slug' => 'medicine', 'name' => 'Медицинские'],

            // Категории для мультфильмов отличные от фильмов и сериалов
            ['id' => 24, 'slug' => 'vzroslye', 'name' => 'Для взрослых'],
            ['id' => 25, 'slug' => 'polnometrazhnye', 'name' => 'Полнометражные'],
            ['id' => 26, 'slug' => 'razvivayuschie', 'name' => 'Развивающие'],
            ['id' => 27, 'slug' => 'serialy', 'name' => 'Сериалы'],
        ...
        DB::table('kino_category_sub')->insert([
            // Фильмы
            ['category_id' => 1, 'sub_category_id' => 4, 'title' => 'Боевики', 'description' => 'Фильмы жанра боевик - это не просто постоянная стрельба и игра в кошки мышки хорошего героя с плохим.'],
            ...
            ['category_id' => 1, 'sub_category_id' => 9, 'title' => 'Драмы', 'description' => 'Вы не относитесь к числу поклонников фильмов с бесконечными драками, бешеными погонями и стрельбой, а предпочитаете по-настоящему душевное кино?'],
            ...
            ['category_id' => 1, 'sub_category_id' => 11, 'title' => 'Комедии', 'description' => 'Любишь смотреть онлайн комедии с участием Эдди Мёрфи, Джима Керри или Адама Сэндлера?'],
            ...
            ['category_id' => 1, 'sub_category_id' => 13, 'title' => 'Мелодрамы', 'description' => 'Хотите смотреть кино и испытывать при этом только самые глубокие и приятные чувства?'],
            ...
            ['category_id' => 1, 'sub_category_id' => 15, 'title' => 'Триллеры', 'description' => 'Хочется острых ощущений? Значит, пришла пора посмотреть леденящие кровь триллеры . '],
            ['category_id' => 1, 'sub_category_id' => 16, 'title' => 'Ужасы', 'description' => 'Пробегающий по коже мороз, острое желание забраться под одеяло с головой, перед этим проверив, крепко ли заперты двери, холодная дрожь по спине от любого шороха на кухне…'],
            ...
            ['category_id' => 1, 'sub_category_id' => 19, 'title' => 'Зарубежные фильмы', 'description' => ''],

            // Сериалы
            ['category_id' => 2, 'sub_category_id' => 20, 'title' => 'Сериалы в жанре аниме', 'description' => ''],
            ...
            ['category_id' => 2, 'sub_category_id' => 21, 'title' => 'Дорамы', 'description' => 'Чарующая Восточная Азия становится ближе и доступнее благодаря популярным дорамам, которые можно смотреть бесплатно в нашем онлайн-кинотеатре на русском языке и в хорошем качестве.'],
            ...
            ['category_id' => 2, 'sub_category_id' => 22, 'title' => 'Сериалы - Латиноамериканские', 'description' => ''],
            ['category_id' => 2, 'sub_category_id' => 23, 'title' => 'Медицинские сериалы', 'description' => 'Не только доктор Хаус – сериалы про врачей и медицину пользуются популярностью во всем мире и год за годом притягивают к экранам миллионы зрителей.'],
            ...
            // Мультфильмы
            ['category_id' => 3, 'sub_category_id' => 20, 'title' => 'Аниме', 'description' => 'Аниме – совершенно особый и неповторимый жанр.'],
